...
bool ofGstUtils::startPipeline(){
    ...
    switch (ret) {
        ...
        case GST_STATE_CHANGE_NO_PREROLL:
            ofLogVerbose("ofGstUtils") << "Pipeline is live and does not need PREROLL waiting PLAY";
        ...
        case GST_STATE_CHANGE_ASYNC:
            ofLogVerbose("ofGstUtils") << "Pipeline is PREROLLING";
            ...
            if(!isStream && gst_element_get_state(gstPipeline,&state,NULL,5*GST_SECOND)!=GST_STATE_CHANGE_SUCCESS){
                ...
                ofLogVerbose("ofGstUtils") << "Pipeline is PREROLLED";
            }
            break;
